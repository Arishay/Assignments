...
let friendNames: string[] = ['Zara', 'Aina', 'Amna', 'huma'];
...
let friends: string[] = ["Zara", "Aina", "Amna", "Huma"];
...
let favouriteTransportation:string[] = ["Hilux" , "Electric bike" , "Mountain Bicycle"]
